...
const navItems: NavItem[] = [
  ...
  { label: "Sinyal - Elite", href: "/dashboard/signals?rank=ELITE", icon: faBolt, badge: "Elite" },
  { label: "Sinyal - Crypto", href: "/dashboard/signals?asset_type=CRYPTO", icon: faBolt, badge: "Live" },
  { label: "Sinyal - Forex", href: "/dashboard/signals?asset_type=FOREX", icon: faBolt },
  { label: "Sinyal - IDX", href: "/dashboard/signals?asset_type=STOCK_INDO", icon: faBolt },
